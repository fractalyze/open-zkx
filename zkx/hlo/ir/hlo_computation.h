...
class HloComputation {
 public:
  ...
  // with side-effect may be removed from a computation, but the transformation
  // must guarantee the invariants relevant to the instructions still hold.
 ...
 private:
  ...
  bool EqualInternal(const HloComputation &other, bool is_layout_sensitive,
                     std::optional<absl::FunctionRef<
                         bool(const HloComputation *, const HloComputation *)>>
