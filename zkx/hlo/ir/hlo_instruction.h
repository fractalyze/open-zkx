...
class HloInstruction {
 public:
  ...
  // captured by normal data dependencies.
  ...
  std::pair<HloInstruction *, ShapeIndex> LatestNonGteAncestorAndIndex() {
    auto rv = const_cast<const HloInstruction *>(this)
                  ->LatestNonGteAncestorAndIndex();
  ...
  // today, the metadata will be propagated to the derived instruction.
...
// a "string" or a JSON-like dict surrounded in {}. This can be used to store
// stringified MLIR-dictionaries with pretty printing.
