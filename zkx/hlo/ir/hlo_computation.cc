...
HloComputation::Clone(const std::string &suffix, HloCloneContext *context) {
...
HloInstruction *HloComputation::GetInstructionWithName(std::string_view name) {
  ...
  auto it =
      absl::c_find_if(instructions_in_computation, [&](HloInstruction *instr) {
