...
void HloInstruction::Users::AddUser(HloInstruction *user) {
  if (!Contains(user)) {
    ...
    if (user_map_ == nullptr && users_.size() >= kMapThreshold) {
      user_map_ = std::make_unique<
          absl::flat_hash_map<const HloInstruction *, int64_t>>(users_.size());
      RebuildMap();
      DCHECK(CheckInvariants());
    }
...
HloInstruction::CreateParameter(int64_t parameter_number, const Shape &shape,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateConstant(Literal literal) {
  return std::make_unique<HloConstantInstruction>(std::move(literal));
}

// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateIota(const Shape &shape, int64_t iota_dimension) {
  return std::make_unique<HloIotaInstruction>(shape, iota_dimension);
}

// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateConstant(Literal literal, const Shape &shape) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateNary(const Shape &shape, HloOpcode opcode,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateUnary(const Shape &shape, HloOpcode opcode,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateBinary(const Shape &shape, HloOpcode opcode,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateTernary(const Shape &shape, HloOpcode opcode,
                              HloInstruction *lhs, HloInstruction *rhs,
                              HloInstruction *ehs) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateVariadic(const Shape &shape, HloOpcode opcode,
                               absl::Span<HloInstruction *const> operands) {
  std::optional<int> arity = HloOpcodeArity(opcode);
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateMap(const Shape &shape,
                          absl::Span<HloInstruction *const> operands,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateDot(const Shape &shape, HloInstruction *lhs,
                          HloInstruction *rhs,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateBitcast(const Shape &shape, HloInstruction *operand) {
  auto instruction =
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateReduce(const Shape &shape, HloInstruction *operand,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateReduce(const Shape &shape,
                             absl::Span<HloInstruction *const> operands,
...
std::unique_ptr<HloInstruction>
HloInstruction::CreateReduce(const Shape &shape,
                             HloInstruction *tuple_of_instructions,
                             absl::Span<HloInstruction *const> init_values,
                             absl::Span<const int64_t> dimensions_to_reduce,
                             HloComputation *reduce_computation) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateReverse(const Shape &shape, HloInstruction *operand,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateBitReverse(const Shape &shape, HloInstruction *operand,
                                 absl::Span<const int64_t> dimensions) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateTuple(absl::Span<HloInstruction *const> elements) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateWhile(const Shape &shape, HloComputation *condition,
                            HloComputation *body, HloInstruction *init) {
  auto instruction =
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateSlice(const Shape &shape, HloInstruction *operand,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateConcatenate(const Shape &shape,
                                  absl::Span<HloInstruction *const> operands,
                                  int64_t dimension) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateConvert(const Shape &shape, HloInstruction *operand) {
  auto instruction =
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreatePad(const Shape &shape, HloInstruction *operand,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateReshape(const Shape &shape, HloInstruction *operand,
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateTranspose(const Shape &shape, HloInstruction *operand,
                                absl::Span<const int64_t> dimensions) {
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateFusion(const Shape &shape, FusionKind fusion_kind,
...
bool HloInstruction::HasSideEffectNoRecurse() const { return false; }
...
// static
std::unique_ptr<HloInstruction>
HloInstruction::CreateCall(const Shape &shape,
...
std::unique_ptr<HloInstruction>
HloInstruction::CloneWithNewShape(const Shape &shape, const std::string &suffix,
                                  HloCloneContext *context) const {
  std::unique_ptr<HloInstruction> clone =
...
std::unique_ptr<HloInstruction>
HloInstruction::Clone(const std::string &suffix,
                      HloCloneContext *context) const {
  std::unique_ptr<HloInstruction> clone =
...
absl::Status
HloInstruction::AddControlDependencyTo(HloInstruction *instruction) {
...
absl::Status
HloInstruction::RemoveControlDependencyTo(HloInstruction *instruction) {
  TF_RET_CHECK(instruction->parent() == parent());
  if (has_rare()) {
...
absl::Status
HloInstruction::ReplaceUseWithDifferentShape(HloInstruction *user,
                                             HloInstruction *new_producer) {
...
absl::Status
HloInstruction::ReplaceOperandWithDifferentShape(int64_t operand_num,
                                                 HloInstruction *new_operand) {
...
absl::Status
HloInstruction::ReplaceUsesWith(absl::Span<HloInstruction *const> users,
                                HloInstruction *new_producer) {
  TF_RET_CHECK(ShapeUtil::Compatible(shape(), new_producer->shape()))
...
absl::Status
HloInstruction::ReplaceAllUsesWithDifferentShape(HloInstruction *new_producer) {
...
std::vector<int64_t>
HloInstruction::operand_indices(const HloInstruction *target) const {
...
HloInstruction::ExtraAttributesToString(const HloPrintOptions &options) const {
...
std::string
FrontendAttributesToString(const FrontendAttributes &frontend_attributes) {
...
HloInstruction::HloInstruction(HloOpcode opcode, const Shape &shape)
    : unique_id_(-1), index_in_parent_(~0u), opcode_(opcode),
      is_default_config_(false), cleaned_up_(false), marked_as_dead_(false),
      is_root_(false), shape_(shape), name_(HloOpcodeString(opcode)) {
  DCHECK_OK(ShapeUtil::ValidateShapeWithOptionalLayout(shape_));
}

template <typename HloInstructionPtr>
absl::Status
HloInstruction::Visit(DfsHloVisitorBase<HloInstructionPtr> *visitor) {
  switch (opcode_) {
  case HloOpcode::kAbs:
...
template <typename Visitor>
static absl::Status
PostOrderDFS(HloInstruction *root, Visitor *visitor,
...
template <typename HloInstructionPtr>
absl::Status
HloInstruction::Accept(DfsHloVisitorBase<HloInstructionPtr> *visitor,
                       bool call_finish_visit, bool ignore_control_predecessors,
...
absl::Status
HloInstruction::AcceptWithOperandOrder(DfsHloVisitor *visitor,
...
HloInstruction::OperandIndices(const HloInstruction *operand) const {
...
private:
  static UseKind
  ComputeInternal(int64_t outer_param_num, const HloInstruction &hlo,
...
HloInstruction::fused_parameters() const {
...
const ScatterDimensionNumbers &
HloInstruction::scatter_dimension_numbers() const {
...
absl::StatusOr<HloInstruction::FusionKind>
StringToFusionKind(std::string_view kind_name) {
  if (kind_name == "kLoop") {
