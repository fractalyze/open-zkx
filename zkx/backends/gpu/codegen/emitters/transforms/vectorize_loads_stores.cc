...
mlir::VectorType GetVectorType(mlir::RankedTensorType tensor_type,
  ...
  // Only vectorize standard numeric types. Field types (e.g., !field.pf<...>)
  // implement VectorElementTypeInterface but cannot be vectorized before field
  // type lowering passes convert them to standard integer types.
