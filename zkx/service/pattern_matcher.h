...
template <typename Item, typename... Patterns> struct AnyOfImpl {
...
template <typename... Patterns> struct AnyOfImpl<HloInstruction, Patterns...> {
  auto operator()(const Patterns &...patterns) const {
...
template <typename ScalarTy> inline auto ConstantScalar(ScalarTy val) {
...
template <typename ScalarTy> inline auto ConstantEffectiveScalar(ScalarTy val) {
