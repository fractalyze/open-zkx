...
struct CanonicalDebugOptions {
  explicit CanonicalDebugOptions(const DebugOptions& opts)
    ...
    bool output_format_other_than_url_specified =
        opts.zkx_dump_hlo_as_text() || opts.zkx_dump_hlo_snapshots() ||
        opts.zkx_gpu_dump_hlo_unoptimized_snapshots();
    bool output_format_specified = output_format_other_than_url_specified;
...
// module.
std::string TimestampFor(const HloModule& module) { return ""; }
