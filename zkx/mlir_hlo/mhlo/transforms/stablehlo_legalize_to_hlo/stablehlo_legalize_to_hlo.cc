...
void populateStablehloToHloPatterns(RewritePatternSet *patterns,
                                    TypeConverter *converter,
                                    MLIRContext *context) {
  // Populate conversion patterns for all supported StableHLO ops.
  // Listed explicitly to match the ops defined in map_stablehlo_to_hlo_op.h.
  populateStablehloToHloPatterns<
      stablehlo::AbsOp, stablehlo::AddOp, stablehlo::AndOp,
      stablehlo::BitcastConvertOp, stablehlo::BitReverseOp,
      stablehlo::BroadcastInDimOp, stablehlo::BroadcastOp, stablehlo::CaseOp,
      stablehlo::ClampOp, stablehlo::ClzOp, stablehlo::CompareOp,
      stablehlo::ConcatenateOp, stablehlo::ConstantOp, stablehlo::ConvertOp,
      stablehlo::CreateTokenOp, stablehlo::DivOp, stablehlo::DotGeneralOp,
      stablehlo::DynamicBroadcastInDimOp, stablehlo::DynamicSliceOp,
      stablehlo::DynamicUpdateSliceOp, stablehlo::GatherOp,
      stablehlo::GetDimensionSizeOp, stablehlo::GetTupleElementOp,
      stablehlo::IfOp, stablehlo::IotaOp, stablehlo::MapOp, stablehlo::MaxOp,
      stablehlo::MinOp, stablehlo::MulOp, stablehlo::NegOp, stablehlo::NotOp,
      stablehlo::OrOp, stablehlo::PadOp, stablehlo::PopulationCountOp,
      stablehlo::PowOp, stablehlo::RealDynamicSliceOp, stablehlo::ReduceOp,
      stablehlo::ReduceWindowOp, stablehlo::RemOp, stablehlo::ReshapeOp,
      stablehlo::ReturnOp, stablehlo::ReverseOp, stablehlo::ScatterOp,
      stablehlo::SelectOp, stablehlo::SetDimensionSizeOp,
      stablehlo::ShiftLeftOp, stablehlo::ShiftRightArithmeticOp,
      stablehlo::ShiftRightLogicalOp, stablehlo::SignOp, stablehlo::SliceOp,
      stablehlo::SubtractOp, stablehlo::TransposeOp, stablehlo::TupleOp,
      stablehlo::WhileOp, stablehlo::XorOp>(patterns, converter, context);
}
