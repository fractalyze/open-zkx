...
load("//third_party/gpus/cuda/hermetic:cuda_json_init_repository.bzl", "cuda_json_init_repository")
load("//third_party/highwayhash:workspace.bzl", highwayhash = "repo")
load("//third_party/implib_so:workspace.bzl", implib_so = "repo")
load("//third_party/jsoncpp:workspace.bzl", jsoncpp = "repo")
...
load("//third_party/version:workspace.bzl", version = "repo")
load("//third_party/zkbench_cpp:workspace.bzl", zkbench_cpp = "repo")
